...
enum errType {
    ...
    // Function parsing
    ExpectingLBracket,		// missing left bracket in function definition
    IllegalFName,			// illegal function name
    ExpectingSemi,			// expecting a semicolon
    ExpectingEqual			// expecting an equal
};

//	void SetErrorDisplays(MTextControl *c, MTextView *v, MWindow *w);
//	int32 Error(const char *text, const char *b1 = NULL, const char *b2 = NULL, const char *b3 = NULL, alert_type type = B_WARNING_ALERT);
//	void Error(errType err, int32 errpos = 0);
